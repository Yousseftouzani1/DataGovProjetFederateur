...
# ==== SYSTÈME RAG GRATUIT POUR LOI 09-08 ET GUIDE CNIL ====
# 100% gratuit - Aucune clé API nécessaire
# Optimisé pour vos documents sur la réglementation

# ==== INSTALLATION (Cellule 1) ====
!pip install -q pypdf sentence-transformers faiss-cpu langchain-community langchain-text-splitters

# ==== CODE PRINCIPAL (Cellule 2) ====
